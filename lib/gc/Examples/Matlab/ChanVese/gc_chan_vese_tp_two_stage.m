% gc_chan_vese_tp_two_stage   Calculate two-stage topology preserving Chan-Vese 
%                             segmentation via graph cuts.
%
% SYNOPSIS:
%  [seg energy iter1 iter2 fc1 fc2] = gc_chan_vese_tp_two_stage(img, ilab, mu, 
...
%  [seg2 energy iter c1 c2] = gc_chan_vese_tp_two_stage(s2n, seg1, 1, 10, 10);
%
% PARAMETERS:
%  See gc_chan_vese_tp and gc_chan_vese_two_stage for documentation of the 
%  input parameters.
%
...
%
% DESCRIPTION:
%  Computes the two-stage topology preserving Chan-Vese segmentation of the
%  input image with given weights via graph-cut based optimization. See
%  gc_chan_vese_tp and gc_chan_vese_two_stage for more details.
%
% NOTES:
%  See gc_chan_vese.
%
...
function [seg energy iter1 iter2 fc1 fc2] = gc_chan_vese_tp_two_stage(img, ilab, mu, lambda1, lambda2, bandradius, nb1, nb2, log, conv1, conv2, maxiter1, maxiter2, c1, c2)
...
% Coarse segmentation
[seg energy iter1 c1 c2] = GcChanVeseTp(img, ilab, lambda1 / mu, lambda2 / mu, c1, c2, conv1, maxiter1, nb1, log);
...
% Refine segmentation
[seg energy iter2 fc1 fc2] = GcChanVeseTp(img, seg, lambda1 / mu, lambda2 / mu, c1, c2, conv2, maxiter2, nb2, log, mask);
